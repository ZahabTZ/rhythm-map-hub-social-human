...
INSERT INTO chat_messages (id, topic_id, region, thread, content, author_id, author_name, message_type) VALUES
  -- San Francisco - Housing & Homelessness Solutions (city-level community, so use city region)
  ('msg_sf_1', 'community_sf', 'city', 'intro', 'Hi everyone! I''m Alex, a housing advocate working with local nonprofits. Let''s collaborate to make SF more affordable and supportive for everyone.', 'user_sf_1', 'Alex Chen', 'text'),
  ('msg_sf_2', 'community_sf', 'city', 'content', 'Our community housing initiative just secured 50 transitional housing units in the Tenderloin! We''re also expanding our job placement program. Volunteers welcome!', 'user_sf_1', 'Alex Chen', 'text'),
  
  -- Arusha - Wildlife Conservation (city-level)
  ('msg_arusha_1', 'community_arusha', 'city', 'intro', 'Welcome! I''m Sarah, a wildlife ranger at Arusha National Park. Excited to connect with fellow conservationists!', 'user_tanzania_1', 'Sarah Mwangi', 'text'),
  ('msg_arusha_2', 'community_arusha', 'city', 'content', 'Our anti-poaching patrols spotted a herd of 15 elephants near the Athi River today. Great to see population recovery!', 'user_tanzania_2', 'James Omondi', 'text'),
  
  -- Miami - Hurricane Preparedness (city-level)
  ('msg_miami_1', 'community_miami', 'city', 'intro', 'Hi everyone, I''m Maria, emergency coordinator for Miami-Dade. Here to help keep our community safe during hurricane season!', 'user_miami_1', 'Maria Rodriguez', 'text'),
  ('msg_miami_2', 'community_miami', 'city', 'content', 'Hurricane season starts June 1st. Please stock up on water (1 gallon per person per day for 3 days), batteries, and non-perishable food.', 'user_miami_1', 'Maria Rodriguez', 'text'),
  
  -- Tokyo - Earthquake Response (city-level)
  ('msg_tokyo_1', 'community_tokyo', 'city', 'intro', 'こんにちは! I''m Kenji, disaster preparedness coordinator. Let''s work together to keep Tokyo safe.', 'user_tokyo_1', 'Kenji Tanaka', 'text'),
  ('msg_tokyo_2', 'community_tokyo', 'city', 'content', 'Reminder: Our monthly earthquake drill is this Saturday at 10am. Please participate from your neighborhoods!', 'user_tokyo_1', 'Kenji Tanaka', 'text'),
  
  -- Amsterdam - Climate Adaptation (city-level)
  ('msg_amsterdam_1', 'community_amsterdam', 'city', 'intro', 'Hoi! I''m Lars, urban planner focused on flood prevention. Amsterdam has centuries of experience living with water - let''s share it!', 'user_amsterdam_1', 'Lars van der Berg', 'text'),
  ('msg_amsterdam_2', 'community_amsterdam', 'city', 'content', 'Just finished installing new water pumps in Noord district. Our adaptive flood barrier system saved 200+ homes during last week''s storm surge!', 'user_amsterdam_1', 'Lars van der Berg', 'text'),
  
  -- Sydney - Bushfire Preparedness (city-level)
  ('msg_sydney_1', 'community_sydney', 'city', 'intro', 'G''day everyone! I''m Rachel, volunteer firefighter. Here to help prepare our communities for bushfire season.', 'user_sydney_1', 'Rachel Thompson', 'text'),
  ('msg_sydney_2', 'community_sydney', 'city', 'content', 'Create defensible space around your property: Clear leaves from gutters, trim trees away from house, keep lawn mowed. These simple steps save lives!', 'user_sydney_1', 'Rachel Thompson', 'text'),
  
  -- Mumbai - Monsoon Resilience (city-level)
  ('msg_mumbai_1', 'community_mumbai', 'city', 'intro', 'Namaste! I''m Priya, monsoon preparedness coordinator for Mumbai Metropolitan Region. Here to keep our city moving during heavy rains.', 'user_mumbai_1', 'Priya Sharma', 'text'),
  ('msg_mumbai_2', 'community_mumbai', 'city', 'content', 'Monsoon update: Heavy rainfall expected next week. Check flood-prone area list, download BMC Disaster Management app, keep emergency numbers handy.', 'user_mumbai_1', 'Priya Sharma', 'text'),
  
  -- São Paulo - Urban Sustainability (city-level)
  ('msg_saopaulo_1', 'community_sao_paulo', 'city', 'intro', 'Olá! Sou Carlos, working on green infrastructure projects across São Paulo. Let''s make our city more sustainable together!', 'user_saopaulo_1', 'Carlos Silva', 'text'),
  ('msg_saopaulo_2', 'community_sao_paulo', 'city', 'content', 'Our vertical garden project in Vila Madalena reduced building temperature by 5°C and improved air quality. We''re expanding to 10 more neighborhoods!', 'user_saopaulo_1', 'Carlos Silva', 'text'),
  
  -- Dubai - Water Conservation (city-level)
  ('msg_dubai_1', 'community_dubai', 'city', 'intro', 'مرحبا! I''m Fatima, water conservation engineer. In the desert, every drop counts - let''s innovate together!', 'user_dubai_1', 'Fatima Al Mansoori', 'text'),
  ('msg_dubai_2', 'community_dubai', 'city', 'content', 'New desalination plant using solar power just went online! 40% more efficient than old system. Dubai is leading the way in sustainable water tech.', 'user_dubai_1', 'Fatima Al Mansoori', 'text'),
  
  -- Global Climate Action
  ('msg_climate_global_1', 'community_climate_global', 'global', 'intro', 'Hello world! This is our global coordination hub for climate action. Together we can make a difference across all continents!', 'user_global_1', 'Dr. Emma Wilson', 'text'),
  ('msg_climate_global_2', 'community_climate_global', 'global', 'content', 'Major milestone: 150 cities worldwide committed to carbon neutrality by 2040! Our grassroots advocacy is creating real policy change.', 'user_global_1', 'Dr. Emma Wilson', 'text'),
  
  -- Global Refugee Support
  ('msg_refugees_global_1', 'community_refugees_global', 'global', 'intro', 'Welcome to our global refugee support network. We coordinate resources, legal aid, and resettlement assistance across borders.', 'user_global_2', 'Hassan Ibrahim', 'text'),
  ('msg_refugees_global_2', 'community_refugees_global', 'global', 'content', 'Urgent: 5,000 families need winter supplies in northern camps. We have logistics partners ready. Please donate or volunteer if you can help.', 'user_global_2', 'Hassan Ibrahim', 'text')
ON CONFLICT (id) DO NOTHING;
