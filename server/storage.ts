...
export class MemStorage implements IStorage {
  ...
  private initializeSampleChatMessages() {
    const sampleMessages = [
      ...
      {
        id: 'msg_nairobi_1',
        communityId: 'community_nairobi',
        region: 'global' as const,
        thread: 'intro' as const,
        content: 'Welcome! I\'m Sarah, a wildlife ranger at Nairobi National Park. Excited to connect with fellow conservationists!',
        authorId: 'user_kenya_1',
