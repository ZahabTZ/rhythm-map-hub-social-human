...
const MapView: React.FC<MapViewProps> = ({ onLocationSelect, onHumanitarianClick, humanitarianMode: externalHumanitarianMode, onMapReady, onRegionSelect }) => {
  ...
  const initializeMap = (token: string) => {
    ...
    map.current.on('load', () => {
      ...
      // Humanitarian crisis data points (Oct 15, 2025 - Current global snapshot)
      const crisisData = {
        "type": "FeatureCollection" as const,
        "features": [
          // Gaza/OPT - Aid access heavily constrained
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [34.4669, 31.5017]}, "properties": {
            ...
            "affected": "~2.1M in need of food aid",
            "image": "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=400&h=300&fit=crop"
          }},
          // Sudan - Largest crisis ever
          ...
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [44.2075, 15.5527]}, "properties": {
            ...
            "affected": "~19.5M people need aid in 2025",
            "image": "https://images.unsplash.com/photo-1591608971362-f08b2a75731a?w=400&h=300&fit=crop"
          }},
          // Afghanistan - Winter risks, service shutdowns
          ...
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [45.3182, 2.0469]}, "properties": {
            ...
            "affected": "~6M in need, >3.5M displaced",
            "image": "https://images.unsplash.com/photo-1593113598332-cd288d649433?w=400&h=300&fit=crop"
          }},
          // South Sudan - Flooding + violence
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [31.5656, 6.877]}, "properties": {
            "intensity": 85, 
            "id": "south-sudan-2025",
            "name": "South Sudan", 
          ...
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [-1.5616, 12.2383]}, "properties": {
            ...
            "affected": "~5.9M in need, >2M IDPs",
            "image": "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=400&h=300&fit=crop"
          }},
          // Chad - Host to Sudan refugees
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [15.0444, 12.1348]}, "properties": {
            ...
            "affected": "~1.28M Sudanese refugees",
            "image": "https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=400&h=300&fit=crop"
          }},
          // Rohingya/Bangladesh - Cox's Bazar refugees
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [92.1265, 21.4272]}, "properties": {
            "intensity": 75, 
            "id": "rohingya-2025",
            "name": "Rohingya (Bangladesh)", 
            "description": "Refugees in Cox's Bazar and Bhasan Char.",
            "affected": "~1.1-1.2M refugees; 2025 JRP targets 1.48M",
            "image": "https://images.unsplash.com/photo-1528181304800-259b08848526?w=400&h=300&fit=crop"
          }},
          // Central African Republic - Limited access/funding
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [18.5582, 4.3947]}, "properties": {
            "intensity": 70, 
            "id": "car-2025",
            "name": "Central African Republic", 
            "description": "Limited humanitarian access and funding.",
            "affected": "~2.4M highly vulnerable",
            "image": "https://images.unsplash.com/photo-1584380931214-dbb5b72e7fd0?w=400&h=300&fit=crop"
          }},
          // Lebanon - Economic collapse
          {"type": "Feature" as const, "geometry": {"type": "Point" as const, "coordinates": [35.5018, 33.8886]}, "properties": {
            "intensity": 75, 
            "id": "lebanon-2025",
            "name": "Lebanon", 
